...
async function main() {
  ...
  const deployer = await ethers.getSigner("0x1234567890123456789012345678901234567890");
  ...
  const ledger = await new LedgerSigner(factory.signer.provider, derivationPath); 
